...
app = dash.Dash(__name__, external_stylesheets=external_stylesheets,title = "Cluster Analysis")
server = app.server

app.layout = html.Div([ 
                       
                       html.H4('Cluster Analysis of Stocks in Dow 30 index with Fundamental Data'),

        

                        html.Br(),
                        html.H5('Select Fundamental Data Year:'),
                        ...
                        html.Br(),
                        html.Label('Select the input features/metrics for Cluster Analysis Model. (Select minimum of 3 features)'),
                        ...
                        dcc.Graph(id='graph_3d',figure = blank_fig(),
                                  style={'width': '90%', 'height': '80vh','padding-top': '15px'}),
                        html.Br(), 
